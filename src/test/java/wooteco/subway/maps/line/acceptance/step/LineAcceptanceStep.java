...
public class LineAcceptanceStep {
    public static ExtractableResponse<Response> 지하철_노선_등록되어_있음(final String name, final String color) {
    ...
    public static ExtractableResponse<Response> 지하철_노선_조회_요청(final Long lineId) {
        return RestAssured.given().log().all().
                accept(MediaType.APPLICATION_JSON_VALUE).
                when().
    ...
    public static ExtractableResponse<Response> 지하철_노선_수정_요청(final ExtractableResponse<Response> response, final String name,
            final String color) {
        final String uri = response.header("Location");
    ...
    public static ExtractableResponse<Response> 지하철_노선_제거_요청(final ExtractableResponse<Response> response) {
        final String uri = response.header("Location");
    ...
    public static void 지하철_노선_목록_포함됨(final ExtractableResponse<Response> response,
            final List<ExtractableResponse<Response>> createdResponses) {
        final List<Long> expectedLineIds = createdResponses.stream()
