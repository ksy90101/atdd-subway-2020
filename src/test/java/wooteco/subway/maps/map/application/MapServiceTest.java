...
public class MapServiceTest {
    ...
    void setUp() {
        ...
        final Line line1 = TestObjectUtils.createLine(1L, "2호선", "GREEN");
        line1.addLineStation(new LineStation(1L, null, 0, 0));
        final LineStation lineStation2 = new LineStation(2L, 1L, 2, 2);
        line1.addLineStation(new LineStation(2L, 1L, 2, 2));

        final Line line2 = TestObjectUtils.createLine(2L, "신분당선", "RED");
        line2.addLineStation(new LineStation(2L, null, 0, 0));
        line2.addLineStation(new LineStation(3L, 2L, 2, 1));

        final Line line3 = TestObjectUtils.createLine(3L, "3호선", "ORANGE");
        line3.addLineStation(new LineStation(1L, null, 0, 0));
        final LineStation lineStation6 = new LineStation(4L, 1L, 1, 2);
        final LineStation lineStation7 = new LineStation(3L, 4L, 2, 2);
        line3.addLineStation(lineStation6);
        line3.addLineStation(lineStation7);

        lines = Lists.newArrayList(line1, line2, line3);

        final List<LineStationEdge> lineStations = Lists.newArrayList(
    ...
    void findPath() {
        ...
        final PathResponse pathResponse = mapService.findPath(1L, 3L, PathType.DISTANCE, loginMember);
    ...
    void findMap() {
        ...
        final MapResponse mapResponse = mapService.findMap();
